...
# --- Load province areas from JSON (generated by generate_geojson.py) ---
PROVINCE_AREAS = {}
try:
    ...
    # Fallback: set a default area
    PROVINCE_AREAS = {}

# --- Province definitions (same as before, includes all UN countries except tiny islands, plus Palestine/Kosovo) ---
PROVINCES = {
    "Eastern Europe": [
    ...
    "Eastern North America": [
        "United States"  # duplicate? We'll handle by putting USA in both? Actually we'll assign USA to Western and Eastern? We'll keep as is.
    ],
    "Mexico": ["Mexico"],
    "Central America": [
    ...
    "Eastern South America": [
        "Brazil"  # but we have Brazil subregion separately
    ],
    "Brazil": ["Brazil"],
    "Southern Cone": [
    ...
    "Pacific Islands": [
        "Papua New Guinea"  # other tiny islands excluded
    ],
    "Antarctic Peninsula": [],
    "East Antarctica": [],
    "West Antarctica": [],
...
# Neighbour data (used for adjacency when no subregion fully owned)
SUBREGION_DATA = {
...
class TerritoryCog(commands.Cog):
    ...
    def _add_province(self, user_id: str, province: str) -> bool:
        ...
        # Also update territory land_size
        area = self.province_areas.get(province, 1000)  # default 1000 km² if missing
    ...
    def _get_expansion_options(self, user_id: str) -> List[str]:
        ...
        possible = set()
        # If any subregion fully owned, allow global expansion
    ...
    async def expand(self, ctx, *, province: str = None):
        ...
        # ---- Resource cost: 5x original (was 10x, now 5x) ----
